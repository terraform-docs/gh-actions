...
`v0.7.0` (uses [terraform-docs] v0.13.0, which is supported and tested on Terraform
...
jobs:
  docs:
    ...
    - name: Render terraform docs inside the USAGE.md and push changes back to PR branch
      uses: terraform-docs/gh-actions@v0.7.0
      with:
        working-dir: .
...
Complete examples can be found [here](https://github.com/terraform-docs/gh-actions/tree/v0.7.0/examples).
